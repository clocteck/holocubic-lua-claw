...
local TOOL_DEFS = {
  ...
  },
  {
    ...
    ["function"] = {
      ...
      description = "Read basic app, device, storage, WeChat status, and current screen brightness.",
      parameters = {
        type = "object",
        properties = {
          include_details = {
  ...
  },
  {
    ...
    ["function"] = {
      name = "set_brightness",
      description = "Set device screen brightness from 1 to 100. For relative changes, read current status first when the current value matters.",
      parameters = {
        type = "object",
        properties = {
